...
class AppColors {
  ...
  static const Color lightOrange = Color(0xffFF8F4A);
  static const Color orange = Color(0xffF56E35);
  static const Color darkOrange = Color(0xffF55A31);
  static const Color brown = Color(0xff733333);
  ...
  static const Color grey = Color(0xffD1D7E3);
